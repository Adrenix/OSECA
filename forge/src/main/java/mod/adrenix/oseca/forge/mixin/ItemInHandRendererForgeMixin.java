package mod.adrenix.oseca.forge.mixin;
...
public abstract class ItemInHandRendererForgeMixin
{
     ...
     */
    @ModifyArg(method = "renderHandsWithItems", index = 8, at = @At(value = "INVOKE", ordinal = 0, target = "Lnet/minecraftforge/client/ForgeHooksClient;renderSpecificFirstPersonHand(Lnet/minecraft/world/InteractionHand;Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;IFFFFLnet/minecraft/world/item/ItemStack;)Z"))
    protected ItemStack onRenderItem(InteractionHand hand, PoseStack matrix, MultiBufferSource buffer, int i, float g, float f4, float f5, float f6, ItemStack itemStack)
    {
     ...
     * Controlled by reequip toggle.
     */
    @Redirect(method = "tick", at = @At(value = "INVOKE", ordinal = 0, target = "Lnet/minecraftforge/client/ForgeHooksClient;shouldCauseReequipAnimation(Lnet/minecraft/world/item/ItemStack;Lnet/minecraft/world/item/ItemStack;I)Z"))
