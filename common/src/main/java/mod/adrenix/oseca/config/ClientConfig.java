...
public class ClientConfig implements ConfigData
{
    ...
    public static class Sounds
    {
        ...
        @Comment("Set this to false to disable attack sounds like sweeping and critical hits.")
        public boolean attack = DefaultConfig.Sounds.ATTACK;
    }
    ...
    {
        @ConfigEntry.Gui.Tooltip
        @Comment("Set this to true to overlay the current Minecraft version on the HUD like before Minecraft 1.0.")
        public boolean oldVersionOverlay = DefaultConfig.EyeCandy.OLD_VERSION_OVERLAY;

        @ConfigEntry.Gui.Tooltip
        @Comment("Set this to true to remove the white border and add yellow text with a blue background when hovering over buttons.")
        public boolean oldButtonHover = DefaultConfig.EyeCandy.OLD_BUTTON_HOVER;
        ...
        @ConfigEntry.Gui.Tooltip
        @Comment("Set this to true to disable item merging. This will not work in multiplayer.")
    ...
    public static class Animations
    {
        ...
        @ConfigEntry.Gui.Tooltip
        @Comment("Set this to false to prevent a subtle animation that happens when trying to move while colliding with a block.")
        public boolean shouldCollideBob = DefaultConfig.Animations.SHOULD_COLLIDE_BOB;
