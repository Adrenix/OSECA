...
import mod.adrenix.oseca.config.gui.ItemSuggestionHelper;
import mod.adrenix.oseca.config.gui.widget.CustomizedRowList;
import mod.adrenix.oseca.config.gui.widget.ToggleCheckbox;
...
public class CustomizeScreen extends SettingsScreen
{
    ...
    {
        super(parent, new TranslatableComponent("gui.oseca.settings.customize"));

        this.parent = parent;
        this.undo = Maps.newHashMap(config.custom);

        int x = 2, y = TOP_ROW_Y, w = CHECKBOX_W, h = CHECKBOX_H;
        this.toolsCheckbox = new ToggleCheckbox(this, x, y + 27, w, h, new TranslatableComponent("gui.oseca.customize.tool"), true);
        this.blocksCheckbox = new ToggleCheckbox(this, x, y + 52, w, h, new TranslatableComponent("gui.oseca.customize.block"), true);
        this.itemsCheckbox = new ToggleCheckbox(this, x, y + 77, w, h, new TranslatableComponent("gui.oseca.customize.item"), true);
        this.resetCheckbox = new ToggleCheckbox(this, x, y - 1, w, h, new TranslatableComponent("gui.oseca.customize.reset"), false);
    }
    ...
    {
        Component message = new TranslatableComponent("gui.oseca.customize.add").withStyle(ChatFormatting.WHITE);
    ...
    private class WidgetProvider
    {
        ...
        {
            Component tooltip = new TranslatableComponent("gui.oseca.customize.add.@Tooltip").withStyle(ChatFormatting.GREEN);
            return new Button(
        ...
        {
            Component tooltip = new TranslatableComponent("gui.oseca.customize.autofill.@Tooltip").withStyle(ChatFormatting.YELLOW);
            return new Button(
        ...
        public Button createResetButton()
        {
            List<Component> tooltip = Lists.newArrayList(
                new TranslatableComponent("gui.oseca.customize.reset.@Tooltip[0]").withStyle(ChatFormatting.RED),
                new TranslatableComponent("gui.oseca.customize.reset.@Tooltip[1]").withStyle(ChatFormatting.WHITE)
            );
